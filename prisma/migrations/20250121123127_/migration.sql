/*
  ...
  - You are about to drop the column `email` on the `RefreshToken` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "RefreshToken" DROP CONSTRAINT "RefreshToken_email_fkey";

-- DropIndex
DROP INDEX "RefreshToken_email_key";

-- AlterTable
ALTER TABLE "RefreshToken" DROP COLUMN "email",
